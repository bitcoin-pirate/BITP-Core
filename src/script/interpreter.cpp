    ...
    try
    {
        while (pc < pend)
        {
            ...
            switch (opcode)
            {
                ...
                case OP_EQUAL:
                case OP_EQUALVERIFY:
                //case OP_BITPQUAL: // use OP_NUMBITPQUAL
                {
                    // (x1 x2 - bool)
                    if (stack.size() < 2)
                        return set_error(serror, SCRIPT_ERR_INVALID_STACK_OPERATION);
                    ...
                    // OP_BITPQUAL is disabled because it would be too easy to say
                    // something like n != 1 and have some wiseguy pass in 1 with extra
                    // zero bytes after it (numerically, 0x01 == 0x0001 == 0x000001)
                    //if (opcode == OP_BITPQUAL)
                    //    fEqual = !fEqual;
                    popstack(stack);
                    popstack(stack);
                ...
                case OP_0BITPQUAL:
                {
                    ...
                    case OP_0BITPQUAL:  bn = (bn != bnZero); break;
                ...
                case OP_MAX:
                {
                    ...
                    case OP_NUMBITPQUAL:         bn = (bn1 != bn2); break;

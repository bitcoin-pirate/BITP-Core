...
BITP: Offline builds must use the --url flag to ensure Gitian fetches only from local URLs. For example:
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the bitcoinpirate.org server.

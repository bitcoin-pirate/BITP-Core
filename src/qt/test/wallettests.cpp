...
void TestGUI()
{
    ...
    // BitcoinPirate: Disable BumpFee tests
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: bitcoinpirate:")) != -1);

...
"""Verify that starting bitcoinpirate with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitcoinpirate with -h for help text")
        ...
        self.log.info("Start bitcoinpirate with -version for version information")

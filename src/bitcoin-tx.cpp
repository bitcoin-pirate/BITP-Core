...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bitcoinpirate-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bitcoinpirate-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitcoinpirate transaction") + "\n" +
              "  bitcoinpirate-tx [options] -create [commands]   " + _("Create hex-encoded bitcoinpirate transaction") + "\n" +
              "\n";
